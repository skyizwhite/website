...
(defcomp ~icon-fediverse (&key class)
  (hsx
   (svg :class class :viewbox "0 0 26.458 25.582" :aria-hidden "true"
     (path :fill "currentColor"
       :d "M12.296 0v.783l.322 5.112l-4.266-2.834l-.679-.392l-.933 1.615l.678.392l4.588 2.277l-4.588 2.277l-.678.392l.933 1.616l.678-.392l4.266-2.835l-.322 5.112v.783h1.866v-.783l-.322-5.112l4.266 2.835l.678.392l.933-1.616l-.678-.392l-4.588-2.277l4.588-2.277l.678-.392l-.933-1.615l-.678.392l-4.266 2.834l.322-5.112V0zM5.555 11.676v.783l.322 5.111l-4.266-2.834l-.679-.392l-.933 1.616l.679.392l4.588 2.277l-4.588 2.277l-.679.392l.933 1.616l.679-.392l4.266-2.835l-.322 5.112v.783h1.866v-.783l-.322-5.112l4.266 2.835l.679.392l.933-1.616l-.679-.392l-4.588-2.277l4.588-2.277l.679-.392l-.933-1.616l-.679.392l-4.266 2.834l.322-5.111v-.783zm13.482 0v.783l.322 5.112l-4.266-2.835l-.679-.392l-.933 1.616l.679.392l4.587 2.277l-4.587 2.277l-.679.392l.933 1.616l.679-.392l4.266-2.835l-.322 5.112v.783h1.866v-.783l-.322-5.112l4.266 2.835l.679.392l.933-1.616l-.679-.392l-4.587-2.277l4.587-2.277l.679-.392l-.933-1.616l-.679.392l-4.266 2.834l.322-5.111v-.783z"))))
...
(defcomp ~icon-heart-outline (&key class)
  (hsx
   (svg :class class :viewbox "0 0 24 24"
     :fill "none" :stroke "currentColor" :stroke-width "2"
     :stroke-linecap "round" :stroke-linejoin "round" :aria-hidden "true"
